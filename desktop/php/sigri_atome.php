<?php
	...
	sendVarToJS('eqType', 'sigri_atome');
	...
	<div class="col-lg-2 col-md-3 col-sm-4">
		<div class="bs-sidebar">
			<ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
				<a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un compte Atome}}</a>
		...
		<div class="eqLogicThumbnailContainer">
			...
			<?php
				foreach ($eqLogics as $eqLogic) {
					...
					echo "<center>";
					echo '<img src="plugins/sigri_atome/doc/images/sigri_atome_icon.png" height="105" width="95" />';
					echo "</center>";
		...
		<form class="form-horizontal">
			<fieldset>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">{{Nom du compte Atome}}</label>
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" class="eqLogicAttr configuration form-control" data-l1key="configuration" data-l2key="identifiant" placeholder="Email du compte Atome"/>
					</div>
				</div>
				<div class="form-group">
...
<?php include_file('desktop', 'sigri_atome', 'js', 'sigri_atome');?>
